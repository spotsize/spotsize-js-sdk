...
import {setupByAttributes, showQRContainer, hideQRContainer} from "./attributes.js";
...
/**
 * @param {string} organizationId - Your organizationId
 */
...
export const start = async (productId, qrContainer, options) => {
    ...
    try {
        installButtonCheck(_organizationId)
    } catch (e) {
        throw new Error(e);
    }
