...
import {
    ...
    createDynamicLink, sendUsageAcknowledgement
} from './api.js';
    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (options.useMockData) {
                ...
                _to = setTimeout(() => {
                    removeQR();
                    _recommendation = getMockData(productId);
            ...
            _recommendation = await getRecommendations(_organizationId, data.measurmentId);
            _recommendation.requestedProductId = productId;
            _recommendation.options = options;
            storeRecommendationData(_recommendation.id, _organizationId);
...
const handleButtonClick = async () => {
    try {
        ...
        console.log(data.url === location.href);
