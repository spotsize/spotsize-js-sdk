...
/**
 * @param {string|[string]} modelId - Single modelId or a list of modelIds to get recommendations for
 ...
 */
export const start = (modelId, qrContainer, useMockData) => {
